...
<head>
	...
	<!-- Nice Select CSS -->
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/css/niceselect.css">
	<!-- Animate CSS -->
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/css/animate.css">
	<!-- Flex Slider CSS -->
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/css/flex-slider.min.css">
	<!-- Owl Carousel -->
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-4 col-md-12 col-12">
						...
						<div class="top-left">
							<ul class="list-main">
								<li><i class="ti-headphone-alt"></i><?php the_field('phone_number_3',6);?></li>
								<li><i class="ti-email"></i><?php the_field('email',6);?></li>
							</ul>
						</div>
						<!--/ End Top Left -->
					</div>
